...
public class Activity_Add_Official_Student extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gender.setOnItemClickListener((parent, view, position, id) -> genderText = parent.getItemAtPosition(position).toString());
        ...
        collectingDate.setOnClickListener(v -> {
            Calendar cal = Calendar.getInstance();
            int year = cal.get(Calendar.YEAR);
            int month = cal.get(Calendar.MONTH);
            int day = cal.get(Calendar.DAY_OF_MONTH);
        ...
        collectDt = (view, year, month, dayOfMonth) -> {
            month++;
